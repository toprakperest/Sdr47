...
class AntennaSpec:
    ...
    gain_db: Union[float, None] = None  # float | None yerine
    beamwidth_deg: Union[Tuple[float, float], None] = None  # (Yatay, Dikey)
...
PORT_VISUALIZATION_CONTROL = PORT_BASE + 12  # 5550 + 12 = 5562 (eğer çakışma yoksa)
...
COLOR_MAP_TARGET = "viridis"

PORT_PREPROCESSING_OUTPUT = 5557
PORT_VISUALIZATION_CONTROL = 5558
PORT_CALIBRATION_RESULT = 5559
